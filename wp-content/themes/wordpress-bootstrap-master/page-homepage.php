...
<?php get_header(); ?>
<!--<div style="text-align:center;">	<?php if (has_post_thumbnail()) the_post_thumbnail(array(970,420));?></div>-->
	<br><br>
				...
				<div id="main" class="span12 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<div class="hero-unit" style="background-image: url('<?php echo $featured_src[0]; ?>'); background-repeat: no-repeat; background-position: center bottom;">
